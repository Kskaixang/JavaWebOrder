...
<html>
	...
	<body style="padding:20px">
		<form class="pure-form" mathod="post" action="/JavaWebOrder/order">
			<fieldset>
				<legend>訂單</legend>
				品名:
				<select name="item"> 
		...
		<form class="pure-form" mathod="get" action="/JavaWebOrder/order">
			<button type="submit" class="pure-button button-secondary">查看歷史資料</button>		
		</form>
